globals [
  sapling-mortality]
breed [trees tree]
trees-own [age tree_size disperse-distance nhbs n-nhbs]
...
to setup-turtles
  ...
  create-trees 400
  [set color green
    set age random-normal 100 10
    set tree_size random-normal 50 8
    set size 1.5
...
to kill-trees
  ask trees[
  ifelse tree_size > 10
  [if (random-float 1) > (1 - (tree_size * 0.0001))  [die]]
  [if (random-float 1) > (1 - seedling-mortality) [die]]
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"default" 5.0 1 -16777216 true "" "histogram [tree_size] of trees"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles [tree_size] < 10"
