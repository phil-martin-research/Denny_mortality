...
to setup
  ...
  [
    ...
    ; centre of the hills. Hills are at (30, 30) and
    ; (120, 120). The first hill is 100 units high.
    ...
    ifelse elev1 > elev2
    [set elevation elev1 set plabel precision elev1 0]
    [set elevation elev2 set plabel precision elev2 0]
...
to-report corridor-width
  report count patches with [used? = true]
end
@#$#@#$#@
GRAPHICS-WINDOW
665
