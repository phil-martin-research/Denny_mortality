...
to setup
 ...
 file-open "ElevationData.txt"
  ...
  [set size 2
    ...
    setxy 110 - random 10 140 - random 10
    pen-down
...
to go ; This is the master schedule
  ...
  if ticks >= 1000 [export-plot "Corridor-width"
    word "Corridor-output-for-q-" q
    stop]
end

to move ; The butterfly moce procedure, in a turtle context
...
"" ""
PENS
"Clumping2" 1.0 0 -11085214 true "" "plot mean-turtle-count"
