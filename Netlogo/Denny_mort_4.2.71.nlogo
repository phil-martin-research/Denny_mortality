...
globals [mature-count mature-BA mast-year dead-total]
breed [trees tree]
breed [juveniles juvenile]
trees-own [age BA tree-size-t1 tree-size-t2 disperse-distance growth-rate tree-density dist-dead]
juveniles-own [age tree_size disperse-distance tree-density]
