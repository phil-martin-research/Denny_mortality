...
to setup-turtles ;create initial trees
  ...
  [set color green
    set age random-exponential mean-tree-age
    ...
    set tree-density2 count trees in-radius 3
    set size 1.5
  ...
  [set color brown
    ...
    set size 0.5
    set tree-density1 count trees in-radius 3
...
to kill-seedlings
  ...
  ask seedlings [set tree-density1 count trees in-radius 3]
