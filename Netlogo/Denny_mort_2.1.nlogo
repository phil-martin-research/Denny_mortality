...
to kill-trees
  ...
  ask trees [if local-BA > 20 [ask trees with [tree-size-t1 <= 15] in-radius 6.35 [set dead-count 1 set time-dead 0 set pcolor brown die]]] ;change this so that instead it kills of all those smaller trees that cause the BA to be >20m sq
