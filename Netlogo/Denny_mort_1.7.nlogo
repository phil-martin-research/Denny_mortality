...
to kill-trees
  ...
  ask trees [if local-BA > 10 [ask trees in-radius 6.35 with [tree-size-t1 < 20] [set dead-count dead-count + 1 die]]] ;change this so that instead it kills of all those smaller trees that cause the BA to be >20m sq
