...
#subset to remove data prior to 1984 and all trees <10DBH at previous time point
Dead<-subset(Dead,Year>1984&DBH2<10)
...
#subset data to give only data for Beech
