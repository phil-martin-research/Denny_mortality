...
M3<-glmer(Dead~Dead_dist+DBH2+GR+Sand+offset(log(SL))+(1|Block),Dead_F_st2,family=binomial(link="cloglog"))
M4<-glmer(Dead~DBH2+GR+Sand+offset(log(SL))+(1|Block),Dead_F_st2,family=binomial(link="cloglog"))
